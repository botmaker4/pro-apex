...
client.on("ready", async () => {
  ...
  client.user.setActivity(`+help +invite +play #TIDOP`, { type: "PLAYING" });
});
...
client.login(process.env.TOKEN).catch(() => console.log(`Invalid Token Is Provided - Please Give Valid Token!`));